...
RETURNING id, full_name, nin, dob, state, lga, phone, status, created_at, voter_id, polling_station_id
`
...
SELECT id, full_name, nin, dob, state, lga, phone, status, created_at, voter_id, polling_station_id FROM voters
WHERE id = $1
`
